...
using GraceTools.Models.TokenAuth;
...
{
    public abstract class GraceToolsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GraceToolsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GraceToolsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GraceToolsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GraceToolsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GraceToolsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GraceToolsDbContext, Task<T>> func)
        {
            T result;
